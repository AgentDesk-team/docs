...
```text
Em phân tích giúp anh task này cần làm những gì, đặc tả rõ scope/out-of-scope, acceptance criteria, verification, rồi để inbox cho anh review.
```

or:

```text
Task này anh muốn làm luôn. Em đặc tả ngắn gọn, chọn agent phù hợp, rồi đề xuất move Ready cho anh xác nhận.
```
